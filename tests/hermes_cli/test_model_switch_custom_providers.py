...
def _disable_live_model_catalogs(monkeypatch):
    """Picker unit tests must not query the developer's local endpoints.

    Tests that exercise successful discovery replace this stub explicitly.
    """
