...
class TestSystemdServiceRefresh:
    ...
    def _simulate_user_bus(self, monkeypatch):
        """Service routing tests mock systemctl; they are not D-Bus probes."""
...
class TestGatewaySystemServiceRouting:
    @pytest.fixture(autouse=True)
    def _simulate_user_bus(self, monkeypatch):
        """Keep these unit tests independent of the host's service manager."""
        monkeypatch.setattr(gateway_cli, "_preflight_user_systemd", lambda: None)
